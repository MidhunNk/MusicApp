...
class CreatorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(255, 33, 31, 31),
        title:const Text('Creators',style: TextStyle(
            ...
            child: Column(
              children: [
                ...
                _buildCreatorCard(
                  ...
                  photoUrl: 'assets/image/mike.jpg', // Replace with actual photo URL
                ),
                const SizedBox(height: 20),
                _buildCreatorCard(
                  name: 'Asim Jasim',
                  ...
                  photoUrl: 'assets/image/WhatsApp Image 2023-12-20 at 13.23.42_b5147daf.jpg', // Replace with actual photo URL
                ),
                const SizedBox(height: 20),
                _buildCreatorCard(
                  name: 'Aswaj C',
                  ...
                  photoUrl: 'assets/image/aswaj2.jpg', // Replace with actual photo URL
                ),
                const SizedBox(height: 20),
              ],
            ),
  ...
  Widget _buildCreatorCard({required String name, required String description, required String photoUrl}) {
    return Card(
      elevation: 4,
